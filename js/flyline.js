Main.flyLine = function(angle){
	...
	function addLongTrace(xPass, dif, timeC){
		longTracer = new createjs.Bitmap(Resource.get(CDN + "img/longtraces.png"));
	...
	function addTrace(dif){
		var totalD = 0;
		var tracer = new createjs.Bitmap(Resource.get(CDN + "img/traces.png"));
