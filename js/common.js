...
;~function(bt){
	...
	var loading = function(rate, error){
		if(rate > 0 && !loadingDiv){
			...
			loadingDiv.html('<table><tr><td><img class="bt-img" src="https://cdn.jsdelivr.net/gh/XianwuLin/xianwulin.github.com@1.0/games/daqie/img/preloadImage.png" /><div class="bt-text"></div></td></tr></table>');
...
;~function(bt){
	...
	var dataForWeixin={
	   // appId:bt.URL.appId,
	   width:"66",
	   src: "https://cdn.jsdelivr.net/gh/XianwuLin/xianwulin.github.com@1.0/games/daqie/img/icon.png",
